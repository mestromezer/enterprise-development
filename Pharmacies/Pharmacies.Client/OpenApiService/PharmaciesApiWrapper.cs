...
{
    public readonly PharmaciesAutogeneratedClient _client = new(configuration["OpenApi:ServerUrl"], new HttpClient());
    ...
    public async Task DeletePharmacy(int id) => await _client.PharmaciesDELETEAsync(id);
